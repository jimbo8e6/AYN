...
youtube:
  - id: "pPhWh8AyKaY"
    label: "clip of Adventures of Rocky and Bullwinkle and Friends. All credit to Socke on Youtube"
  - id: "fLCC2MwgTIY"
    label: "Intro to the original animated series"
...
*The Adventures of Rocky and Bullwinkle and Friends* is yet another licensed platformer, they really did hand out these licenses like candy in the 80s and 90s. Video games today may have a wider reach and a bigger audience in terms of numbers, but the explosion of gaming from home computer games to console games in the late 80s and 90s was like nothing else. Companies saw dollar signs using their IPs and gaming really was considered the next big thing. It's funny that now it is such a huge commodity, the licensed games have dropped off dramatically. There are still licensed games released of course, but every new film used to have a video game counterpart, every big TV series or cartoon, it was such an interesting time.

It was released in 1993 for the SNES and Genesis/Mega Drive. There was also a version released for the NES and Game Boy in 1992.

The game was developed by **Absolute Entertainment**, starting in the early 80s they developed various games for the Atari 2600 before getting involved in the very licensed games boom that I just mentioned, *Simpsons*, *Star Trek*, even *Home Improvement* and that Robin Williams film *Toys* (see what I mean about every movie getting a game).
...
The music is fine, it fits the feel of the game, and I imagine, the show (I've never seen it, I think it was mostly a US thing) very jaunty bouncy music, and it's fairly well put together. It does have that longer track that ends up sounding a bit looped feeling, but each level has its own music that's different to the last. It's just not something I could ever sit and listen to, it's a bit of a cacophony of noise, which I feel like is exactly the sort of thing you'd hear on the show, but it doesn't work outside of the realms of the game.

The sound is pretty non existent, a few sound effects when you jump and fire, and when enemies get hit, some explosions, but very much nothing to write home about.
