...
![Addams Family: Pugsley's Scavenger Hunt logo](/games/addams-family-pugsleys-scavenger-hunt/logo.png)

*Addams Family: Pugsley's Scavenger Hunt* released the year after *The Addams Family* for the SNES, NES and Game Boy. The NES and Game Boy versions were actually ports of the previous game with Gomez being replaced by Pugsley, whereas the SNES had a brand new game, in a similar style to the first, but based on the animated series and not the movie, so the graphics had an overhaul, with a new vibrant style.
...
For a second time they've done exactly what they need to with the front cover, like the previous game was just the movie poster, this is just essentially a promo art piece for the animated series, but it tells you exactly what you're getting, it's a lot brighter and more colourful than the last game, and would definitely catch your eye in the game store.
