---
title: "The 7th Saga"
sortTitle: "7th Saga, The"
developer: "Produce!"
publisher: "Enix"
released: "1993"
region: "Japan as Elnard, North America 1993"
players: "1 player"
genre: ["RPG"]
status: "played"
score: 6
...
magazineReviews:
  - magazine: "Add magazine name"
    issue: "Issue number"
    date: "Month Year"
    score: "00%"
    quote: "PLACEHOLDER — replace with a transcribed quote from your own copy."
---
...
butter, but I think you could say that licensed platformers are the bread, and
JRPGs are the butter for the Super Nintendo library. The backbone of 90s
Nintendo gaming. The Super Nintendo is where JRPGs really started to take big
steps away from their 8-bit counterparts, and to this day brand new JRPGs are
released in this graphical style. It really is timeless.
...
overworld, visiting towns and dungeons, talking to people, spending money in the
...
similar way to how you'd choose a character type in a *Final Fantasy*, but the
interesting part is once you've chosen your character, the remaining characters
are dropped into the world and they are trying to complete the same quest as
you. You'll come across them in towns: some will offer to join you, some just
won't care about you, some will even betray you and try and kill you. You can
...
aren't so random, and the idea is you can avoid them if you would prefer to.
There are 2 problems with this. One is the enemies move so erratically there's
just no feasible way to avoid the encounter. The second problem is the game is
really fucking hard, so you have to level up, you have to grind, so you have to
fight the enemies if you want any chance of completing the game, but adding to
...
> I was closely involved in the development of the 7th Saga. And no, while I
> believe it's probably not as exciting to hear, we didn't increase the
> difficulty level from the Japanese version. It's possible the game had tuning
> changes from the Japan side to the US version but it wasn't a mandate to make
> the game harder. It's likely that we determined the game in Japan wasn't
> challenging enough based on feedback, and thus, tuning adjustments were made.
> We changed some of the puzzles, in terms of the questions you were asked in
> order to solve the puzzle but the challenge remained the same.
>
> Keep in mind: at the time, you had a wide range of age groups playing SNES
> games. Depending on your age level the game was either pretty straightforward
> or challenging. If I think back on some of the puzzle questions, and imagine an
> 8 year old trying to figure out some of the riddles, yep, would have felt
> impossibly hard. We just posed riddles meant to get people thinking but
> impossibly hard? Not even close. You want to talk about hard, try Ninja Gaiden
> 2… That was the bar of difficulty back then and was responsible for more broken
> television sets, consoles and controllers than any other game to date. (Only to
> be topped by the first release of Street Fighter.)

The full interview is a good read and can be found
[here](http://gaming.moe/?p=331).

The battle mechanics themselves are difficult too. Usually in a JRPG, battles
are designed so offensive strategies are enough to see you through, but in this
a regular attack does barely any damage; an attack after defending will do a
critical hit. This drags the battles on forever and gives the enemy a free hit
...
enemy attacks you, defend again because you lost your crit chance, get attacked
again, and then attempt your critical hit and pray it doesn't get dodged again
or you have to repeat the cycle once more. Very frustrating!

There are some really nice details about the game though. One of my favourite
things was some of the context-sensitive dialogues with NPCs. Go into town while
poisoned, and someone you just spoke to would have different dialogue
recognising you're poisoned and telling you where to get an antidote. Meet up
with another of the 7 while your partner is knocked out, and they'll say how
you've failed your partner. Little touches like that just make the game world
...
The graphics in the game are the big selling point. The sprites are beautiful
and made the insanely punishing battles bearable. I was genuinely excited to get
